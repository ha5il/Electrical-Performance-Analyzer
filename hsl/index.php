  ...
  <body>
      <nav>
	   ...
	   <center><h4><?php if ($row == 1) echo ("Error in DATA.CSV, make sure it exists!"); else echo ("DATA.CSV successfully processed!");?></h4></center>
	              ...
	              <div class="card-panel hoverable" style="text-align:center">
               <div class="row">
                  <div class="col s12">
                     <ul class="tabs">
...
<div id="report">
<?php
 include ($_SERVER['DOCUMENT_ROOT'] . '/project/hsl/report.php'); 
?>
</div>
<div id="fluctuations">
<?php
include ($_SERVER['DOCUMENT_ROOT'] . '/project/hsl/fluctuations.php');
?>
</div>
<div id="skips">
<?php
include ($_SERVER['DOCUMENT_ROOT'] . '/project/hsl/skips.php');
?>
</div>
<div id="module">
<!-- All From Word -->
